...
>
> - [Implementare una rete perimetrale tra Azure e il data center locale](/azure/architecture/reference-architectures/dmz/secure-vnet-hybrid)
> - [Implementare una rete perimetrale tra Azure e Internet](/azure/architecture/reference-architectures/dmz/secure-vnet-dmz)
...
[4]: ./images/network-hub-spoke-block-level-diagram.png "Diagramma del livello di blocco di hub e spoke"
...
[8]: ./images/network-vnet-peering-perimeter-neworks.png "Peering reti virtuali e reti perimetrali"
