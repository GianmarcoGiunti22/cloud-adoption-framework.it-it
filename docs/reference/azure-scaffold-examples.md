...
| Tipo di risorsa | name | Description |
| --- | --- | --- |
...
| Tipo di blocco | Gruppi | Description |
| --- | --- | --- |
...
| Campo | Effetto | Description |
| --- | --- | --- |
| location |deny |Negare la creazione di risorse all'esterno dei data center degli Stati Uniti |
| tags |deny |Richiede il tag del proprietario dell'applicazione |
